...
# Observacoes
- Restauração de 23/07/2026: a cena de entrada voltou literalmente aos tempos e movimentos anteriores à implementação do loading por engrenagem (3,7 segundos, encontro das formas, pulso, logo e slogan). Ela agora monta sempre na abertura da home, logo após o loading técnico, sem depender de `sessionStorage`.
...
- Camada de movimento implementada em 17/07/2026: loading de página centralizado com engrenagem da marca e transição de encaixe entre rotas internas. Em 23/07, a intro foi restaurada para a versão visual anterior de 3,7 segundos e deixou de depender de memória de sessão.
