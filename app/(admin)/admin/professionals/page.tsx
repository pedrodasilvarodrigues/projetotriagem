    ...
    <AppShell eyebrow="Administrador" title="Profissionais">
      <div className="space-y-5">
        ...
        <section className="rounded-lg border border-slate-200 bg-white p-4 shadow-sm">
          <h2 className="text-lg font-semibold">Historico recente de apresentacoes</h2>
          <div className="mt-3 grid gap-2">
            ...
            {(presentations ?? []).length === 0 ? <p className="text-sm text-slate-500">Nenhuma apresentacao registrada ainda.</p> : null}
          </div>
        </section>
      </div>
    </AppShell>
