...
const profileErrorMessages: Record<string, string> = {
  ...
  "service_cpf_required": "Informe e salve um CPF válido antes de ativar a oferta de serviços.",
  "service_activation_blocked": "Este cadastro não pode ser ativado para oferecer serviços."
};
...
export default async function ProfessionalProfilePage({ searchParams }: { searchParams: Promise<{ error?: string; message?: string; offerServices?: string }> }) {
  ...
  const providerIsBanned = provider?.status === "banned";
