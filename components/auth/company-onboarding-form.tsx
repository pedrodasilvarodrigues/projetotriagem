    ...
    <form action={saveCompanyAction} className="rounded-lg border border-slate-200 bg-white p-6 shadow-sm">
      ...
      <section>
        ...
        <div className="mt-5 grid gap-4 md:grid-cols-2 lg:grid-cols-3">
          ...
          <label className="block text-sm font-medium">E-mail corporativo (opcional)<input name="corporateEmail" type="email" value={corporateEmail} onChange={(event) => setCorporateEmail(event.target.value)} placeholder="Usaremos o e-mail da conta se ficar vazio" className="mt-1 w-full rounded-md border border-slate-300 px-3 py-2 text-sm" /></label>
