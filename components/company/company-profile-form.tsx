  ...
  return (
    <form action={action} className="rounded-lg border border-slate-200 bg-white p-5 shadow-sm">
      ...
      <div className="grid gap-4 md:grid-cols-2">
        ...
        <label className="text-sm font-semibold">E-mail corporativo<input name="corporateEmail" type="email" disabled={!editing} value={corporateEmail} onChange={(event) => setCorporateEmail(event.target.value)} className="field-input mt-2 disabled:bg-slate-100" /></label>
        ...
        <label className="text-sm font-semibold">E-mail do responsável<input name="contactEmail" type="email" disabled={!editing} value={contactEmail} onChange={(event) => setContactEmail(event.target.value)} className="field-input mt-2 disabled:bg-slate-100" /></label>
